...
export const TRANSLATIONS: Record<Lang, Translation> = {
  EN: {
    ...
    profile: "Profile",
    bio: "Founded in 2024, draftspace Studio is an architectural practice committed to the rigorous investigation of geometric form and material honesty. We operate between regional contexts and global standards, seeking clarity in every gesture.",
    ...
    servicesDesc: "From conceptual modeling to technical execution, we provide comprehensive architectural solutions for complex environments.",
    otherServicesTitle: "Other Services / Project Parallel",
    processes: [
      { t: "Process 01 / Strategy", d: "We begin every project with deep site analysis and programmatic optimization to ensure the structural integrity matches the functional requirements." },
      { t: "Process 02 / Execution", d: "Our execution phase involves precise documentation and coordination with high-standard engineering teams to deliver uncompromising architecture." }
    ],
    aboutTeamCulture: "Team / Culture",
    teamRoles: ["Architects", "Engineers", "Strategists", "Designers"],
    aboutStudioProfile: "Studio Profile",
    credentials: [
      { t: "RIBA", d: "Chartered 2019" },
      { t: "ARB", d: "Registered 2020" }
    ],
  ...
  VI: {
    ...
    profile: "Hồ sơ",
    bio: "Được thành lập vào năm 2024, draftspace Studio là một văn phòng kiến trúc cam kết nghiên cứu nghiên cứu hình khối và tính chân thực của vật liệu. Chúng tôi hoạt động giữa bối cảnh khu vực và tiêu chuẩn toàn cầu, tìm kiếm sự rõ ràng trong từng chi tiết.",
    ...
    servicesDesc: "Từ việc dựng mô hình ý tưởng đến thực thi kỹ thuật, chúng tôi cung cấp các giải pháp kiến trúc toàn diện cho những môi trường phức tạp.",
    otherServicesTitle: "Dịch vụ khác / Song hành dự án",
    processes: [
      { t: "Quy trình 01 / Chiến lược", d: "Chúng tôi bắt đầu mọi dự án bằng việc phân tích kỹ lưỡng địa điểm và tối ưu hóa chương trình để đảm bảo tính toàn vẹn về cấu trúc phù hợp với yêu cầu chức năng." },
      { t: "Quy trình 02 / Thực thi", d: "Giai đoạn thực thi bao gồm việc lập hồ sơ chính xác và phối hợp với các đội ngũ kỹ thuật tiêu chuẩn cao để mang lại những kiến trúc không thỏa hiệp." }
    ],
    aboutTeamCulture: "Đội ngũ / Văn hóa",
    teamRoles: ["Kiến trúc sư", "Kỹ sư", "Nhà chiến lược", "Nhà thiết kế"],
    aboutStudioProfile: "Hồ sơ Studio",
    credentials: [
      { t: "RIBA", d: "Chứng chỉ 2019" },
      { t: "ARB", d: "Đăng ký 2020" }
    ],
    projectNotFound: "Không tìm thấy dự án",
    returnHome: "Quay về trang chủ",
    selectedWork: "Dự án Tiêu biểu",
    architecturalIntent: "Ý đồ Kiến trúc",
