  ...
  return (
    ...
    >
      ...
      <header className="mb-24">
        <h2 className="text-6xl md:text-9xl font-black uppercase tracking-tighter">{t.aboutStudioProfile}</h2>
        <div className="mt-12 flex flex-col md:flex-row gap-12 items-start justify-between">
          ...
          <div className="space-y-4 text-[11px] font-bold uppercase tracking-[0.2em] text-black">
            {t.credentials.map((cred, i) => (
              <div key={i} className="flex gap-4 border-b border-[#e0e0e0] pb-2">
                <span className="text-[#bbb]">{cred.t}</span>
                <span>{cred.d}</span>
              </div>
            ))}
          </div>
      ...
      <div className="mt-48 max-w-5xl">
        <h3 className="text-[11px] font-bold uppercase tracking-[0.3em] text-[#bbb] mb-12 border-b border-[#e0e0e0] pb-4">{t.aboutTeamCulture}</h3>
        <div className="mb-20">
      ...
      <div className="mt-32">
        <h3 className="text-8xl md:text-[12rem] font-black uppercase tracking-tighter opacity-5 select-none">{t.aboutStudioProfile}</h3>
      </div>
    </motion.div>
  );
}
