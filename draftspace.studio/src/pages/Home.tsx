  ...
  return (
    ...
    >
      ...
      <header className="px-8 pt-24 pb-24 border-b border-[#e0e0e0]">
        ...
        >
          <span className="text-[10px] uppercase tracking-[0.3em] font-bold text-[#666] mb-4 block not-italic leading-[14px]">
            Da Nang / Tay Ninh / TP.HCM • 2026
          </span>
          <h1 className="text-[48px] md:text-[80px] lg:text-[120px] font-black uppercase leading-[0.85] tracking-normal">
        ...
        >
          <p className="max-w-xl text-[14px] md:text-lg font-medium leading-tight text-[#666]">
            {t.heroSub}
          </p>
